...
import { I as Route, J as deletePurchaseOrderFn, K as createPurchaseOrderFn, L as updatePurchaseOrderStatusFn, M as receivePurchaseOrderFn } from "./router-CZa_PGzA.js";
    ...
    /* @__PURE__ */ jsx("div", { className: "dash-table-wrap", children: /* @__PURE__ */ jsxs("table", { className: "dash-table", children: [
      ...
      /* @__PURE__ */ jsxs("tbody", { children: [
        ...
        visible.map((po) => /* @__PURE__ */ jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsxs("div", { className: "dash-row-actions", style: {
            justifyContent: "flex-end"
          }, children: [
            /* @__PURE__ */ jsx("a", { href: "#", className: "dash-view-link", onClick: (e) => {
              e.preventDefault();
              setViewingPo(po);
            }, children: "View →" }),
            /* @__PURE__ */ jsx("button", { className: "dash-icon-btn dash-icon-btn--danger", title: "Delete", onClick: () => deletePo(po), children: /* @__PURE__ */ jsx(Trash2, { size: 13 }) })
          ] }) })
        ] }, po.id))
      ] })
    ] }) }),
...
function CreatePurchaseOrderModal({
  ...
  const addItem = () => {
    ...
    setItems([...items, {
      ...
      quantity_ordered: 1,
      unit_cost: sortedProducts[0].cost_price
    }]);
  };
  ...
  return /* @__PURE__ */ jsx("div", { className: "dash-modal-overlay", onClick: onClose, children: /* @__PURE__ */ jsxs("div", { className: "dash-modal dash-modal--wide", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxs("div", { className: "dash-modal__header", children: [
      ...
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("button", { type: "button", className: "dash-link-btn dash-link-btn--danger", onClick: deletePo, disabled: deleting, children: [
