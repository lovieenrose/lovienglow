...
import { X, ChevronDown, Minus, Plus, ShoppingCart, Truck, ShieldCheck, Check, Eye, Star, Search, SlidersHorizontal } from "lucide-react";
import { useState, useMemo } from "react";
import { f as formatPrice } from "./shipping-B_aQucIA.js";
import { u as useStore, P as ProductVisual } from "./router-CZa_PGzA.js";
...
function ProductModal({ product, onClose }) {
  ...
  const gallery = product.gallery && product.gallery.length > 0 ? product.gallery : void 0;
    ...
    /* @__PURE__ */ jsxs("div", { className: "product-modal", role: "dialog", "aria-label": `${product.name} — Product Details`, children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "product-modal__scroll", children: [
        /* @__PURE__ */ jsxs("div", { className: "gallery", children: [
          /* @__PURE__ */ jsx("div", { className: "gallery-thumbs", children: (gallery ?? [0, 1, 2]).map((item, i) => /* @__PURE__ */ jsx(
            "button",
            {
              className: image === i ? "active" : "",
              onClick: () => setImage(i),
              "aria-label": `View image ${i + 1}`,
              children: gallery ? /* @__PURE__ */ jsx("img", { src: gallery[i], alt: `${product.name} ${i + 1}` }) : /* @__PURE__ */ jsx(ProductVisual, { product, compact: true })
            },
            gallery ? item : i
          )) }),
          /* @__PURE__ */ jsx("div", { className: `gallery-main gallery-main--${image}`, children: gallery ? /* @__PURE__ */ jsx("img", { src: gallery[image] ?? gallery[0], alt: product.name, className: "gallery-main__photo" }) : /* @__PURE__ */ jsx(ProductVisual, { product }) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "purchase-panel", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "detail-price", children: product.badge === "coming_soon" ? /* @__PURE__ */ jsx("b", { children: "Price available soon" }) : /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "stock", children: [
            /* @__PURE__ */ jsx("i", {}),
            product.badge ? BADGE_LABEL$1[product.badge] : product.stock < 15 ? `Only ${product.stock} left — order soon` : "In stock and ready to ship"
          ] }),
            ...
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  " ",
                  product.badge ? BADGE_LABEL$1[product.badge] : "Add to Cart"
                ]
              }
            )
          ] }),
...
function ProductCard({ product }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("article", { className: "product-card", children: [
      /* @__PURE__ */ jsxs("div", { className: `product-card__visual ${displayImage ? "product-card__visual--photo" : ""}`, children: [
        /* @__PURE__ */ jsx("button", { className: "visual-open", onClick: () => setOpen(true), "aria-label": `View ${product.name}`, children: displayImage ? /* @__PURE__ */ jsx("img", { src: displayImage, alt: product.name, className: "product-card__photo" }) : /* @__PURE__ */ jsx(ProductVisual, { product }) }),
        /* @__PURE__ */ jsxs("div", { className: "card-badges", children: [
          product.badge && /* @__PURE__ */ jsx("span", { className: `badge badge--${product.badge.replace(/_/g, "-")}`, children: BADGE_LABEL[product.badge] }),
          !product.badge && product.isBestSeller && /* @__PURE__ */ jsx("span", { className: "badge badge--bestseller", children: "Best Seller" }),
          !product.badge && product.isNew && /* @__PURE__ */ jsx("span", { className: "badge badge--new", children: "New" })
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "product-card__body", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "product-card__footer", children: [
          /* @__PURE__ */ jsx("div", { className: "product-card__price", children: product.badge === "coming_soon" ? /* @__PURE__ */ jsx("b", { children: "Price available soon" }) : /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx("b", { children: formatPrice(product.price) }),
            product.compareAt && /* @__PURE__ */ jsx("del", { children: formatPrice(product.compareAt) })
          ] }) }),
          /* @__PURE__ */ jsxs(
...
function ShopPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return [...catalog].filter((product) => category === "All" || product.category === category).filter((product) => `${product.name} ${product.shortDescription} ${product.category}`.toLowerCase().includes(normalized)).sort((first, second) => {
      ...
      return first.name.localeCompare(second.name, void 0, {
        numeric: true,
        sensitivity: "base"
      });
    });
  ...
  return /* @__PURE__ */ jsxs("div", { className: "catalog-page", id: "top", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "category-tabs", role: "tablist", "aria-label": "Product categories", children: PUBLIC_CATEGORIES.map((item) => /* @__PURE__ */ jsx("button", { role: "tab", "aria-selected": category === item, className: category === item ? "active" : "", onClick: () => {
      setCategory(item);
      setVisible(12);
    }, children: item }, item)) }),
    ...
    catalogLoading && catalog.length === 0 ? /* @__PURE__ */ jsx("div", { className: "empty-results", children: /* @__PURE__ */ jsx("p", { children: "Loading products…" }) }) : filtered.length ? /* @__PURE__ */ jsxs(Fragment, { children: [
