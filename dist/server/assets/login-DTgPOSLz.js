...
import { w as ownerEstablishSessionFn } from "./router-2rQkfpAr.js";
...
function LoginPage() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "dash-login", children: /* @__PURE__ */ jsxs("form", { className: "dash-login__card", onSubmit: handleSubmit, children: [
    ...
    /* @__PURE__ */ jsx("h1", { children: "Invory" }),
    ...
    mode === "sign_up" && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs("label", { children: [
        ...
        /* @__PURE__ */ jsx("input", { type: "text", placeholder: "e.g. Retail, Wholesale, Skincare Clinic", value: businessType, onChange: (event) => setBusinessType(event.target.value) })
      ] }),
      /* @__PURE__ */ jsxs("label", { children: [
      ...
      /* @__PURE__ */ jsxs("label", { children: [
        ...
        /* @__PURE__ */ jsx("input", { type: "text", placeholder: "PHP", value: currency, onChange: (event) => setCurrency(event.target.value), required: true })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("label", { children: [
