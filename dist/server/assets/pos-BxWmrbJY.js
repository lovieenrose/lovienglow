...
import { f as formatPeso$1, d as uploadInvoiceBannerFn, e as uploadPaymentProofFn, m as markSalePaidFn, s as swapProductSetOrderFn, h as deleteProductSetFn, i as updateProductSetFn, j as createProductSetFn, k as updatePromoFn, l as createPromoFn, n as deletePromoFn, p as Route, q as completeSaleFn, r as reverseSaleFn } from "./router-CZa_PGzA.js";
...
function ManageProductSetsModal({
  ...
  const sortedProducts = useMemo(
    () => [...products].sort((a, b) => a.name.localeCompare(b.name, void 0, { numeric: true, sensitivity: "base" })),
    [products]
  );
  const startEdit = (set) => {
    setForm({
