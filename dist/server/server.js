...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-dFXuTzcg.js");
...
const manifest = {
  "064d14f6f3a2070bd188f3b9743e542e76e323c704d94d1ca754c9bf98e20a16": {
    ...
    importer: () => import("./assets/serverFunctions-DUrnrDo7.js")
  },
  "b5d79a62f2ea696c5b87d78cff58af6a89b0580c9013340d4fb5b595b897788e": {
    functionName: "adminLoginFn_createServerFn_handler",
    importer: () => import("./assets/serverFunctions-DUrnrDo7.js")
  },
  "43470274709025f0a7d964e6a157857b90e8747ee547ddd70966eb725556d62d": {
    functionName: "adminLogoutFn_createServerFn_handler",
    importer: () => import("./assets/serverFunctions-DUrnrDo7.js")
  },
  "6975ab3f225fad98c98116f277d223680c1181cc5355801e269c5cd6d7a57eb7": {
    functionName: "verifyAdminFn_createServerFn_handler",
    importer: () => import("./assets/serverFunctions-DUrnrDo7.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-DtENt4eu.js").then((n) => n.r),
