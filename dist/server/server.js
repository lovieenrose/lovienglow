...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Bq7IPgRo.js");
...
const manifest = {
  "868bea76e998ff85818e6c2676ad5f8b6f80f0c35ff82c11f0b548d4147e1379": {
    ...
    importer: () => import("./assets/serverFunctions-Cc6tBEg7.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-Cv-N2EiY.js").then((n) => n.U),
