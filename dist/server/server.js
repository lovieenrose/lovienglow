...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-CFnQxKQb.js");
...
const manifest = {
  "868bea76e998ff85818e6c2676ad5f8b6f80f0c35ff82c11f0b548d4147e1379": {
    functionName: "listPublicCatalogFn_createServerFn_handler",
    importer: () => import("./assets/serverFunctions-jKVFyXGL.js")
  },
  "8f7963b3ff28b6081255d0c99ac5efcb92b6c67d8e4c0ac7617db24c530f7d79": {
    functionName: "validatePromoCodeFn_createServerFn_handler",
    importer: () => import("./assets/serverFunctions-jKVFyXGL.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-CZa_PGzA.js").then((n) => n.V),
